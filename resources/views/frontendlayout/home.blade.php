		...
		<div class="post-carousel-lg">
			...
			<div class="post featured-post-xl">
				<div class="details clearfix">
					<a href="category.html" class="category-badge lg">{{$populerpost->category->title }}</a>
					<h4 class="post-title"><a href="blog-single.html">{{$populerpost->title }}</a></h4>
					<ul class="meta list-inline mb-0">
						<li class="list-inline-item"><a href="classic.html#">{{$populerpost->user->name }}</a></li>
						<li class="list-inline-item">{{$populerpost->created_at->toDayDateTimeString()}}</li>
					</ul>
				</div>
				<a href="blog-single.html">
					<div class="thumb rounded">
						<div class="inner data-bg-image" data-bg-image={{asset('storage/'.$populerpost->future_img)}}></div>
					</div>
				</a>
			</div>
			@endforeach
			...
			<div class="col-lg-8">
				...
				<div class="post post-classic rounded bordered">
					<div class="thumb top-rounded">
						<a href="category.html" class="category-badge lg position-absolute">{{$post->category->title}}</a>
						<span class="post-format">
							<i class="icon-picture"></i>
						</span>
						<a href="{{route('allsingleblog',$post->slug)}}">
							<div class="inner">
					...
					<div class="details">
						<ul class="meta list-inline mb-0">
							<li class="list-inline-item"><a href="{{route('allsingleblog',$post->slug)}}"><img src="{{asset('storage/logo/'.$post->user->imgename)}}" style="width: 20px"; class="author" alt="author"/>{{$post->user->name}}</a></li>
							<li class="list-inline-item">{{$post->created_at->toDayDateTimeString()}}</li>
							<li class="list-inline-item"><i class="icon-bubble"></i> (0)</li>
						</ul>
						<h5 class="post-title mb-3 mt-3"><a href="{{route('allsingleblog',$post->slug)}}">{{$post->title}}</a></h5>
						<p class="excerpt mb-0">{{!$post->contant}}</p>
				...
				{{-- <div class="post post-classic rounded bordered">
					<div class="thumb top-rounded">
						...
						<a href="blog-single.html">
							<div class="inner">
								<img src="{{asset('asset/images/posts/post-lg-2.jpg')}}" alt="post-title" />
							</div>
						</a>
					</div>
					<div class="details">
						<ul class="meta list-inline mb-0">
							<li class="list-inline-item"><a href="classic.html#"><img src="{{asset('asset/images/other/author-sm.png')}}" class="author" alt="author"/>Katen Doe</a></li>
							<li class="list-inline-item">29 March 2021</li>
							<li class="list-inline-item"><i class="icon-bubble"></i> (0)</li>
						</ul>
				...
				<div class="post post-classic rounded bordered">
					<div class="thumb top-rounded">
						...
						<a href="blog-single.html">
							<div class="inner">
								<img src="{{ asset('asset/images/posts/post-lg-3.jpg')}}" alt="post-title" />
							</div>
						</a>
					</div>
					<div class="details">
				...
				<div class="post post-classic rounded bordered">
					<div class="thumb top-rounded">
						...
						<a href="blog-single.html">
							<div class="inner">
								<img src="{{asset('asset/images/posts/post-lg-4.jpg')}}" alt="post-title" />
							</div>
						</a>
					</div>
					<div class="details">
				...
				<div class="sidebar">
					...
					<div class="widget rounded">
						<div class="widget-about data-bg-image text-center" data-bg-image="images/map-bg.png">
							<img src="{{ asset('asset/images/logo.svg')}}" alt="logo" class="mb-4" />
					...
					<div class="widget rounded">
						<div class="widget-header text-center">
							...
							<img src="{{asset('asset/images/wave.svg')}}" class="wave" alt="wave" />
						</div>
						<div class="widget-content">
							...
							<div class="post post-list-sm circle">
								<div class="thumb circle">
									...
									<a href="blog-single.html">
										<div class="inner">
											<img src="{{asset('asset/images/posts/tabs-1.jpg')}}" alt="post-title" />
										</div>
									</a>
								</div>
								<div class="details clearfix">
							...
							<div class="post post-list-sm circle">
								<div class="thumb circle">
									...
									<a href="blog-single.html">
										<div class="inner">
											<img src="{{asset('asset/images/posts/tabs-2.jpg')}}" alt="post-title" />
										</div>
									</a>
								</div>
								<div class="details clearfix">
							...
							<div class="post post-list-sm circle">
								<div class="thumb circle">
									...
									<a href="blog-single.html">
										<div class="inner">
											<img src="{{asset('asset/images/posts/tabs-3.jpg')}}" alt="post-title" />
										</div>
									</a>
								</div>
								<div class="details clearfix">
							...
							<div class="post-carousel-widget">
								...
								<div class="post post-carousel">
									<div class="thumb rounded">
										...
										<a href="blog-single.html">
											<div class="inner">
												<img src="{{asset('asset/images/widgets/widget-carousel-1.jpg')}}" alt="post-title" />
											</div>
										</a>
									</div>
								...
								<div class="post post-carousel">
									<div class="thumb rounded">
										...
										<a href="blog-single.html">
											<div class="inner">
												<img src="{{asset('asset/images/widgets/widget-carousel-2.jpg')}}" alt="post-title" />
											</div>
										</a>
									</div>
					...
					<div class="widget no-container rounded text-md-center">
						...
						<a href="classic.html#" class="widget-ads">
							<img src="{{ asset('asset/images/ads/ad-360.png')}}" alt="Advertisement" />	
						</a>
					</div>
